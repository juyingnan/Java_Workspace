...
public class TestCppVisitor extends ASTVisitor implements IJob {

	ArrayList<IASTPreprocessorStatement> preProcessorArr = new ArrayList<IASTPreprocessorStatement>();
	
	public TestCppVisitor() {
		this(true);
	}
	
	public TestCppVisitor(boolean visitNodes) {
		super(visitNodes);

	}	
	
	public int visit(CPPASTTranslationUnit n){
		Log.println("lajilajilaji");
		return PROCESS_SKIP;
	}
