...
public class LongGene
   ...
   * @since 3.0
   */
  public LongGene(final Configuration a_config)
      throws InvalidConfigurationException {
    this(a_config, - (Long.MAX_VALUE / 2),
    		Long.MAX_VALUE / 2);
  }
   ...
   * @since 2.0
   */
  public LongGene(final Configuration a_config, final long a_lowerBound,
                    final long a_upperBound)
      throws InvalidConfigurationException {
    super(a_config);
  ...
  protected Gene newGeneInternal() {
    try {
    	LongGene result = new LongGene(getConfiguration(), m_lowerBound,
                                         m_upperBound);
      return result;
    }
  ...
  public void setValueFromPersistentRepresentation(String a_representation)
    ...
    if (a_representation != null) {
      ...
      try {
        m_lowerBound =
        	Long.parseLong(lowerBoundRepresentation);
      }
      catch (NumberFormatException e) {
        throw new UnsupportedRepresentationException(
            "The format of the given persistent representation " +
      ...
      try {
        m_upperBound =
        	Long.parseLong(upperBoundRepresentation);
      }
      catch (NumberFormatException e) {
        throw new UnsupportedRepresentationException(
            "The format of the given persistent representation " +
  ...
  public void setToRandomValue(RandomGenerator a_numberGenerator) {
    ...
    // ---------------------------------------------------------
    setAllele(new Long( (m_upperBound - m_lowerBound) *
  ...
  protected void mapValueToWithinBounds() {
    if (getAllele() != null) {
      ...
      // boundary is added.
      // ------------------------------------------------------------------
      if (d_value.longValue() > m_upperBound ||
          d_value.longValue() < m_lowerBound) {
        RandomGenerator rn;
        ...
        setAllele(new Long((long)(rn.nextDouble()
  ...
  public void applyMutation(int index, double a_percentage) {
	  long range = (long)((m_upperBound - m_lowerBound) * a_percentage);
	  long newValue = longValue() + range;
