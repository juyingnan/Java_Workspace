...
//	    	System.out.println("!!!!!!!!!!!!:"+clazz.getName());
	        geneClass = clazz;
//	    		geneClass = Class.forName("Student");
	    	}
...
//					geneClass = fs[i].getClass();
//					addGene(new ObjectGene(a_config,fs,depth+1));
					addGene(new ObjectGene(a_config,fs[i].getClass(),depth+1));
				}
	      }
	    }
...
//			  Object obj=geneClass.newInstance();
			  ...
			  Constructor constructor = geneClass.getConstructors()[0];
			  for(int a = 0; a<constructor.getParameterTypes().length;a++){
				  arr.add(1);
			  }
			  obj = constructor.newInstance(arr.toArray());
			  for(int i=0;i<fs.length;i++){
