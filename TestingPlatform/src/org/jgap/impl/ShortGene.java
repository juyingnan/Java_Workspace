...
public class ShortGene
   ...
   * @since 3.0
   */
  public ShortGene(final Configuration a_config)
      throws InvalidConfigurationException {
    this(a_config, (short)(- Short.MAX_VALUE / 2),
   ...
   * @since 2.0
   */
  public ShortGene(final Configuration a_config, final short a_lowerBound,
                    final short a_upperBound)
      throws InvalidConfigurationException {
    super(a_config);
  ...
  protected Gene newGeneInternal() {
    try {
    	ShortGene result = new ShortGene(getConfiguration(), m_lowerBound,
                                         m_upperBound);
      return result;
    }
  ...
  public void setValueFromPersistentRepresentation(String a_representation)
    ...
    if (a_representation != null) {
      ...
      if (valueRepresentation.equals("null")) {
        ...
        try {
          setAllele(new Short(Short.parseShort(valueRepresentation)));
        }
      ...
      try {
        m_lowerBound =
        	Short.parseShort(lowerBoundRepresentation);
      }
      catch (NumberFormatException e) {
        throw new UnsupportedRepresentationException(
            "The format of the given persistent representation " +
      ...
      try {
        m_upperBound =
        	Short.parseShort(upperBoundRepresentation);
      }
      catch (NumberFormatException e) {
        throw new UnsupportedRepresentationException(
            "The format of the given persistent representation " +
  ...
  public short shortValue() {
    return ( (Short) getAllele()).shortValue();
  }
  ...
  public void setToRandomValue(RandomGenerator a_numberGenerator) {
    ...
    // ---------------------------------------------------------
    setAllele(new Short( (short)((m_upperBound - m_lowerBound) *
  ...
  protected void mapValueToWithinBounds() {
    if (getAllele() != null) {
      ...
      // boundary is added.
      // ------------------------------------------------------------------
      if (d_value.shortValue() > m_upperBound ||
          d_value.shortValue() < m_lowerBound) {
        RandomGenerator rn;
        ...
        setAllele(new Short((short)(rn.nextDouble()
  ...
  public void applyMutation(int index, double a_percentage) {
    short range = (short)((m_upperBound - m_lowerBound) * a_percentage);
    short newValue = (short) (shortValue() + range);
    setAllele(new Short(newValue));
  }
  ...
  public String toString() {
    String s = "ShortGene(" + m_lowerBound + "," + m_upperBound + ")"
        + "=";
    if (getInternalValue() == null) {
      s += "null";
    }
