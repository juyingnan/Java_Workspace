...
public class CharGene
   ...
   * @since 3.0
   */
  public CharGene(final Configuration a_config)
      throws InvalidConfigurationException {
    this(a_config, (char)0,
    		(char)255);
  }

  /**
   * Constructs a new CharGene with the specified lower and upper
   ...
   * @since 2.0
   */
  public CharGene(final Configuration a_config, final char a_lowerBound,
                    final char a_upperBound)
      throws InvalidConfigurationException {
    super(a_config);
  ...
  protected Gene newGeneInternal() {
    try {
    	CharGene result = new CharGene(getConfiguration(), m_lowerBound,
                                         m_upperBound);
      return result;
    }
  ...
  public void setValueFromPersistentRepresentation(String a_representation)
    ...
    if (a_representation != null) {
      ...
      if (valueRepresentation.equals("null")) {
        ...
        try {
          setAllele(new Character(valueRepresentation.charAt(0)));
        }
      ...
      try {
        m_lowerBound = 
        	lowerBoundRepresentation.charAt(0);
      }
      catch (NumberFormatException e) {
        throw new UnsupportedRepresentationException(
            "The format of the given persistent representation " +
      ...
      try {
        m_upperBound =
        	upperBoundRepresentation.charAt(0);
      }
      catch (NumberFormatException e) {
        throw new UnsupportedRepresentationException(
            "The format of the given persistent representation " +
  ...
  public char charValue() {
    ...
    return (((Character)getAllele()).charValue());
  }
  ...
  public void setToRandomValue(RandomGenerator a_numberGenerator) {
    ...
    // ---------------------------------------------------------
    setAllele(new Character((char)( (m_upperBound - m_lowerBound) *
                         a_numberGenerator.nextLong() + m_lowerBound)));
  }
  ...
  protected void mapValueToWithinBounds() {
    if (getAllele() != null) {
    	Character d_value = ( (Character) getAllele());
      ...
      // boundary is added.
      // ------------------------------------------------------------------
      if (d_value.charValue() > m_upperBound ||
          d_value.charValue() < m_lowerBound) {
        RandomGenerator rn;
        ...
        setAllele(new Character((char)((float)(rn.nextDouble()
  ...
  public void applyMutation(int index, double a_percentage) {
	  char range = (char)((m_upperBound - m_lowerBound) * a_percentage);
	  char newValue =(char)( charValue() + range);
    setAllele(new Character((char)(newValue)));
  }
