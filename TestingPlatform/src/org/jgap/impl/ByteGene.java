...
public class ByteGene
   ...
   * @since 3.0
   */
  public ByteGene(final Configuration a_config)
      throws InvalidConfigurationException {
    this(a_config, (byte)(- Byte.MAX_VALUE / 2),
   ...
   * @since 2.0
   */
  public ByteGene(final Configuration a_config, final byte a_lowerBound,
                    final byte a_upperBound)
      throws InvalidConfigurationException {
    super(a_config);
  ...
  protected Gene newGeneInternal() {
    try {
    	ByteGene result = new ByteGene(getConfiguration(), m_lowerBound,
                                         m_upperBound);
      return result;
    }
  ...
  public void setValueFromPersistentRepresentation(String a_representation)
    ...
    if (a_representation != null) {
      ...
      if (valueRepresentation.equals("null")) {
        ...
        try {
          setAllele(new Byte(Byte.parseByte(valueRepresentation)));
        }
      ...
      try {
        m_lowerBound =
        	Byte.parseByte(lowerBoundRepresentation);
      }
      catch (NumberFormatException e) {
        throw new UnsupportedRepresentationException(
            "The format of the given persistent representation " +
      ...
      try {
        m_upperBound =
        	Byte.parseByte(upperBoundRepresentation);
      }
      catch (NumberFormatException e) {
        throw new UnsupportedRepresentationException(
            "The format of the given persistent representation " +
  ...
  public byte byteValue() {
    return ( (Byte) getAllele()).byteValue();
  }
  ...
  public void setToRandomValue(RandomGenerator a_numberGenerator) {
    ...
    // ---------------------------------------------------------
    setAllele(new Byte( (byte)((m_upperBound - m_lowerBound) *
  ...
  protected void mapValueToWithinBounds() {
    if (getAllele() != null) {
      ...
      // boundary is added.
      // ------------------------------------------------------------------
      if (d_value.byteValue() > m_upperBound ||
          d_value.byteValue() < m_lowerBound) {
        RandomGenerator rn;
        ...
        setAllele(new Byte((byte)(rn.nextDouble()
  ...
  public void applyMutation(int index, double a_percentage) {
    byte range = (byte)((m_upperBound - m_lowerBound) * a_percentage);
    byte newValue = (byte) (byteValue() + range);
    setAllele(new Byte(newValue));
  }
